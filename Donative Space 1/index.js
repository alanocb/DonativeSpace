...
const donativoonlineRouter = require("./routes/donativoonlineRoutes");

app.use("/api/users", usersRouter);

app.use("/api/organizacao", organizacaoRouter);
app.use("/api/campanhas", campanhasRouter);

app.use("/api/donativofisico", donativofisicoRouter);
app.use("/api/donativoonline", donativoonlineRouter);
